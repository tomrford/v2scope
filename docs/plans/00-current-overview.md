# VScope rewrite overview (legacy Python app + onboard C + vscope-rs notes)

Note: This document is historical. The current protocol source of truth is `onboard/vscope.c`, which is feature-complete and frozen.
